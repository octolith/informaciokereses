...
public class TermRecognizer {
	...
	public TermRecognizer() throws IOException {
        this(new HashSet<String>(
                Util.readLinesIntoList(DEFAULT_STOPWORD_FNAME)));
	}
	
	public TermRecognizer(String fname) throws IOException {
        this(new HashSet<String>(
                Util.readLinesIntoList(fname)));
	}

	public TermRecognizer(Set<String> stopwords) {
		this(stopwords, DEFAULT_DELIMITERS);
	}

	public TermRecognizer(Set<String> stopwords, String delimiters) {
